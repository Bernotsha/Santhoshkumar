...
const AdditionalFeatures = () =>{
    ...
    return(
        <section id='additionalfeatures'>
            ...
            <div id='description'>Break barriers with true cloud-native technology. Our dealer partners can expect:</div>

            <div className='row features'>
                <div className='col-lg-4 featurecards'>
                    <div><img style={{float:"left"}} src={icon2} alt="Not found"/></div>
                ...
                <div className='col-lg-4 featurecards'>
                    ...
                    <div className='imagetext'>Machine Learning and AI Algorithms for Better Experiences</div> 
                </div>
            </div>
